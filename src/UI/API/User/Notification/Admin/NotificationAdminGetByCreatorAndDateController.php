...
class NotificationAdminGetByCreatorAndDateController extends AbstractController
{
    ...
    public function getNotificationsByCreator(Request $request, NotificationAdminFindByCreatorUserAndDateService $findByCreatorUserService): JsonResponse
    {
        try {
            $data = json_decode($request->getContent(), true);
            return $findByCreatorUserService($data['email'], $data['date']);
        } catch (\Exception $e) {
