    ...
    #[OA\Post(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(property: "activity_history_id", type: "integer", example: 1),
                        new OA\Property(property: "name", type: "string", example: "This is the name of an activity history."),
                        new OA\Property(property: "description", type: "string", example: "This is a activity history description."),
            ...
            new OA\Response(
                response: 402,
                description: "Activity History already exists"
            )
        ]
    )]
