...
class NotificationFindByCreatorUserAndDateServiceTest extends Unit
{
    private NotificationRepositoryInterface&MockObject $notificationRepository;
    private NotificationFindByCreatorUserAndDateService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new NotificationFindByCreatorUserAndDateService($this->notificationRepository);
    }
