...
class NotificationFindByCreatorUserServiceTest extends Unit
{
    private NotificationRepositoryInterface&MockObject $notificationRepository;
    private NotificationFindByCreatorUserService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new NotificationFindByCreatorUserService($this->notificationRepository);
    }
