...
use App\User\Application\Notification\NotificationFindByReceiverUserService;
...
class NotificationFindByReceiverUserServiceTest extends Unit
{
    private NotificationRepositoryInterface&MockObject $notificationRepository;
    private NotificationFindByReceiverUserService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new NotificationFindByReceiverUserService($this->notificationRepository);
    }
