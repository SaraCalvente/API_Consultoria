...
class NotificationAdminFindByCreatorUserServiceTest extends Unit
{
    private NotificationRepositoryInterface $notificationRepository;
    private UserRepositoryInterface $userRepository;
    private NotificationAdminFindByCreatorUserService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new NotificationAdminFindByCreatorUserService(
