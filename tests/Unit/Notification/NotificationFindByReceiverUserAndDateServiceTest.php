...
class NotificationFindByReceiverUserAndDateServiceTest extends Unit
{
    private NotificationRepositoryInterface&MockObject $notificationRepository;
    private NotificationFindByReceiverUserAndDateService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new NotificationFindByReceiverUserAndDateService($this->notificationRepository);
    }
