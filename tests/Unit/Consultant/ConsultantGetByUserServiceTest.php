...
class ConsultantGetByUserServiceTest extends Unit
{
    private ConsultantRepositoryInterface $consultantRepository;
    private ConsultantGetByUserService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new ConsultantGetByUserService($this->consultantRepository);
    }
